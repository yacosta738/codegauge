...
CodeGauge `0.2.0` <!-- x-release-please-version --> is a standalone Rust CLI for deterministic JaCoCo evidence and the
...
## CLI `0.2.0` <!-- x-release-please-version -->
...
`profiles` prints exactly `java-jacoco-v1`. `version` prints exactly `codegauge 0.2.0` <!-- x-release-please-version -->.
...
- [ ] Release from an immutable Git revision; retain the exact `codegauge 0.2.0` <!-- x-release-please-version --> version and profile/schema IDs.
